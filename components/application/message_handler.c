...
void protocol_message_handler_task(void *pvParameters) {
  protocol_message_handler_handle_t message_handler =
      (protocol_message_handler_handle_t)pvParameters;
...
esp_err_t protocol_message_handler_init(
  ...
  protocol_message_handler_handle_t message_handler =
      (protocol_message_handler_handle_t)malloc(
          sizeof(protocol_message_handler_t));
  ...
  if (xTaskCreate(protocol_message_handler_task, MESSAGE_HANDLER_TAG,
                  PROTOCOL_MESSAGE_HANDLER_TASK_STACK_DEPTH, message_handler,
                  PROTOCOL_MESSAGE_HANDLER_TASK_PRIORITY,
